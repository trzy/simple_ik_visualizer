...
class CraneX7Joint(StrEnum):
    ...
    UPPER_TWIST = "upper_twist_joint"
    UPPER_ROTATE = "upper_rotate"
    LOWER_FIXED = "lower_fixed"
    LOWER_REVOLUTE = "lower_revolute"
    WRIST = "wrist_joint"
...
class CraneX7Robot:
    ...
    def __init__(self, serial_port: str):
        self._bus = DynamixelBus(
            ...
            baud_rate=57600,
            motors=[
                DynamixelMotor(id=2, model=DynamixelModel.XM430_W350_R, name=CraneX7Joint.SHOULDER_PAN.value),
                DynamixelMotor(id=3, model=DynamixelModel.XM540_W270_R, name=CraneX7Joint.SHOULDER_TILT.value),
                DynamixelMotor(id=4, model=DynamixelModel.XM430_W350_R, name=CraneX7Joint.UPPER_TWIST.value),
                DynamixelMotor(id=5, model=DynamixelModel.XM430_W350_R, name=CraneX7Joint.UPPER_ROTATE.value),
                DynamixelMotor(id=6, model=DynamixelModel.XM430_W350_R, name=CraneX7Joint.LOWER_FIXED.value),
                DynamixelMotor(id=7, model=DynamixelModel.XM430_W350_R, name=CraneX7Joint.LOWER_REVOLUTE.value),
                DynamixelMotor(id=8, model=DynamixelModel.XM430_W350_R, name=CraneX7Joint.WRIST.value),
                DynamixelMotor(id=9, model=DynamixelModel.XM430_W350_R, name=CraneX7Joint.GRIPPER.value)
            ]
        )
    ...
    def goal(self, joint_degrees: Dict[CraneX7Joint, float]):
